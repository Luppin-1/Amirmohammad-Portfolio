export function Projects({ language }) {
  ...
  const projects = isPersian
    ? [
        ...
        { number: '۰۴', title: 'وب‌سایت رستوران', type: 'Landing Page', description: 'لندینگ رستوران با طراحی رسپانسیو و تعاملات کاربری؛ پیاده‌سازی‌شده با فناوری‌های خالص وب.', stack: ['HTML', 'CSS', 'JavaScript'], link: 'https://github.com/Luppin-1/Restuarant' },
